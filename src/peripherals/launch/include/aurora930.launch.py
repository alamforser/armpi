...
def generate_launch_description():
    return LaunchDescription([
        ...
        Node(
            ...
            arguments = ['0', '0', '0', '0', '0', '0', 'depth_camera_link', 'rgb_camera_link'],
            parameters=[{"transform_publish_delay": LaunchConfiguration('transform_publish_delay', default='1.0')}]
        ),

        Node(
            package='tf2_ros',
            executable='static_transform_publisher',
            arguments = ['0', '0', '0', '0', '0', '0', 'rgb_camera_link', 'depth_cam_color_frame'],
            parameters=[{"transform_publish_delay": LaunchConfiguration('transform_publish_delay', default='1.0')}]
        ),
        ...
        Node(
            package='tf2_ros',
            executable='static_transform_publisher',
            arguments = ['0', '0', '0', '0', '0', '0', 'rgb_camera_link', 'depth_cam_depth_optical_frame'],
            parameters=[{"transform_publish_delay": LaunchConfiguration('transform_publish_delay', default='1.0')}]
        ),
        ...
        Node(
            package='tf2_ros',
            executable='static_transform_publisher',
            arguments = ['0', '0', '0', '0', '0', '0', 'depth_cam_color_frame', 'depth_cam_color_optical_frame'],
            parameters=[{"transform_publish_delay": LaunchConfiguration('transform_publish_delay', default='1.0')}]
        ),
    ])
