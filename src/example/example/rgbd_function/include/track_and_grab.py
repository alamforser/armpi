...
class TrackAndGrabNode(Node):
    ...
    def __init__(self, name):
        ...
        # self.client = self.create_client(SetBool, '/depth_cam/set_ldp_enable') #删除
        # self.client.wait_for_service()#删除
    ...
    def init_process(self):
        ...
        servo_positions = ((6, 500), (5, 600), (4, 800), (3, 110), (2, 500), (1, 300))
    ...
    def stop_srv_callback(self, request, response):
        ...
        self.last_pitch_yaw = (0, 0)
        self.last_position = (0, 0, 0)
        servo_positions = ((6, 500), (5, 600), (4, 800), (3, 110), (2, 500), (1, 210))
